...
{/* Título e SubTítulo do Modal */}
      <div className='space-y-2'>
        <div className='flex items-center justify-between'>
          <h2 className='text-zinc-200 text-lg font-semibold'>Selecionar convidados</h2>
...
{/* Email-s */}
      <div className='flex flex-wrap gap-2'>
        {emailsToInvite.map(email => {
          return(
            <div key={email} className='bg-zinc-800 px-2.5 py-1.5 rounded-md flex text-center gap-2'>
...
{/* Digitar e-mail convidado */}
      <form onSubmit={addNewEmailToInvite}  className='p-2.5 bg-zinc-950 rounded-lg border border-zinc-800 flex'>
