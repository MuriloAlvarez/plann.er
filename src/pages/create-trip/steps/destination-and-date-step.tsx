...
export function DestinationAndDateStep({closeGuestsInput, 
    isGuestsInputOpen, 
    openGuestsInput}:DestinationAndDateStepProps)
{
    return(
        ...
        {/* Disable campo de Localização */}
                  {isGuestsInputOpen ? (<div className='flex items-center gap-2 flex-1'>
        ...
        {/* Disable campo de Data */}
                  {isGuestsInputOpen ? (<div className='flex items-center gap-2'>
